...
const HomeLayout = () => {
  ...
  return (
    ...
    >
      <nav className="sticky top-0 z-20 h-14 w-full bg-resume-700 flex py-2.5 px-4 xl:px-60 items-center shadow-level-8dp">
        <Link href="/">
        ...
        <div className="flex-auto flex justify-between items-center ml-5">
          <NavBarActions>
            <Link href="/builder" passHref={true}>
              <StyledButton variant="text">CLA Resume</StyledButton>
            </Link>
          </NavBarActions>
          {/* <NavBarActions>
      ...
      <div
        style={{
          background: "linear-gradient(180deg, #E7EEFA 10%, #FFFFFF 90%)",
        ...
        <div className="mx-6 md:mx-40 xl:mx-60 mb-6">
          ...
          >
            ...
            <div className="col-span-12 sm:col-span-8">
              ...
              <h1 className="text-5xl mb-12 text-resume-800">Modern Resume</h1>
